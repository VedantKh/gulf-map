...
const MAP_META = {
    ...
    "lastUpdated": "2026-03-07T18:23:27.154Z",
    "casualties": {
        "killed": 21,
        "injured": 284
    },
    "conflict": "Iran strikes on Gulf states, Feb 28 – Mar 2, 2026",
    "summary": "Day 8 (Mar 7): Iran President Pezeshkian apologized to Gulf neighbors and pledged to halt attacks on neighboring states unless US strikes originate from them. IRGC endorsed the statement but analysts note IRGC, not the president, controls military operations. Despite ceasefire pledge, IRGC launched dawn drone swarm on Al Dhafra and fresh evening explosions rocked Bahrain, Qatar, and UAE (CNN). Trump demanded Iran's 'unconditional surrender' and warned of escalated strikes. Russia reportedly providing targeting intelligence to Iran (Washington Post).",
    "totalBarrage": "UAE cumulative since Feb 28: 221 ballistic missiles detected (205 destroyed, 14 sea, 2 impacted), 1,305 drones (1,229 intercepted, 76 impacted), 8 cruise missiles (all destroyed). Bahrain cumulative: 78 missiles + 143 drones destroyed. Iran claims 500+ ballistic/naval missiles and ~2,000 drones fired across all targets since Feb 28 (Fars).",
    "intercepted": "Mar 7 alone — UAE: 15/16 ballistic missiles, 119/121 drones. Saudi Arabia: 2 ballistic missiles (toward PSAB), 6 drones (toward Shaybah), 1 drone (east Riyadh). Qatar: missile attack intercepted (details TBD). Jordan: at least 2 missiles intercepted over Aqaba."
};

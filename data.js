...
const MAP_META = {
    ...
    "lastUpdated": "2026-03-07T17:17:10.311Z",
    "casualties": {
        "killed": 21,
        "injured": 284
    },
    "conflict": "Iran strikes on Gulf states, Feb 28 – Mar 2, 2026",
    "summary": "DAY 8 (March 7): Iran's President Pezeshkian issued an unprecedented apology to Gulf neighbors and announced a conditional halt to strikes on neighboring countries, saying the Interim Leadership Council had approved the decision. He attributed previous strikes on civilian areas to 'miscommunication' and 'fire at will' authority within the armed forces. However, a drone struck near Dubai Airport's Concourse A shortly after his speech, and the IRGC issued separate statements reserving the right to strike US bases. Trump called it a 'surrender' and warned Iran would be 'hit very hard' Saturday. CENTCOM confirmed 3,000+ targets hit in first week of Operation Epic Fury, and 43 Iranian warships destroyed.",
    "totalBarrage": "UAE MOD cumulative (as of March 7): 221 ballistic missiles detected (205 destroyed, 14 fell in sea, 2 landed in UAE); 1,305 drones detected (1,229 intercepted, 76 fell in UAE). Iran total since Feb 28: 500+ ballistic/naval missiles and ~2,000 drones (per Fars News Agency via military source). CENTCOM: 3,000+ Iranian targets struck.",
    "intercepted": "Saturday March 7 UAE-specific: 16 BMs detected (15 intercepted, 1 in sea), 121 drones (119 intercepted, 2 fell in UAE). Saudi Arabia: 2 BMs towards PSAB intercepted, 6 drones towards Shaybah intercepted, 1 drone east of Riyadh destroyed. Qatar: missile attack intercepted (details withheld). Jordan cumulative: 108 of 119 projectiles intercepted (90.8%)."
};

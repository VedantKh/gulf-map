...
const MAP_META = {
    ...
    "lastUpdated": "2026-03-05T07:38:41.675Z",
    "casualties": {
        "killed": 21,
        "injured": 176
    },
    "conflict": "Iran strikes on Gulf states, Feb 28 – Mar 2, 2026",
    "summary": "Day 6 of Iran war (March 5). Iran's retaliatory attack volume has dropped significantly — missile launches down 86% and drone strikes down 73% from Day 1 per US Gen. Caine. CENTCOM reports Iran's navy eliminated from Gulf/Hormuz/Gulf of Oman. P&I insurance removed for Hormuz transit effective today. Three new Iraq locations added (Erbil, Baghdad Airport, Sulaimaniyah) reflecting confirmed militia proxy strikes. War continues with no ceasefire in sight.",
    "totalBarrage": "Iran has launched over 500 ballistic missiles and 2,000+ drones in total retaliation (per CENTCOM Adm. Brad Cooper, Day 5). Volume declining sharply: missile launches down 86%, drone strikes down 73% from Day 1.",
    "intercepted": "UAE: 174 ballistic missiles tracked (161 intercepted), 689 drones (645 intercepted), 8 cruise missiles intercepted. Kuwait: 97 ballistic missiles, 283 drones intercepted. Bahrain: 45 missiles, 9 drones. Qatar: 65 missiles, 12 drones. Jordan: 13 ballistic missiles, 49 drones."
};

...
const MAP_META = {
    ...
    "lastUpdated": "2026-03-07T19:21:33.875Z",
    "casualties": {
        "killed": 21,
        "injured": 284
    },
    "conflict": "Iran strikes on Gulf states, Feb 28 – Mar 2, 2026",
    "summary": "Day 8 (March 7). Iran's President Pezeshkian announced intent to halt strikes on Gulf neighbors unless attacks originate from their territory, and apologized for strikes on neighboring countries. However, IRGC continued attacks the same evening — targeting UAE, Bahrain, Qatar and Saudi Arabia. Analysts note IRGC, not the president, controls military decisions. CENTCOM says it has struck 3,000+ Iranian targets and destroyed 43 warships. Ballistic missile launches down ~90% from Day 1 per CENTCOM.",
    "totalBarrage": "Iran has fired over 500 ballistic/naval missiles and ~2,000 drones since Feb 28 (Fars News, Mar 5). On Mar 7 alone: UAE detected 121 drones + 16 ballistic missiles; Saudi intercepted 2 BMs toward PSAB, 6 drones toward Shaybah, 1 drone near Riyadh; Qatar intercepted missile attack. Bahrain total since Feb 28: 78 missiles and 143 drones detected.",
    "intercepted": "Mar 7: UAE intercepted 119/121 drones (2 fell in UAE) and 15/16 ballistic missiles (1 fell to sea). Since conflict start: UAE dealt with 165+ BMs, 541+ drones; Bahrain intercepted 78 missiles, 143 drones total; Kuwait intercepted 97 BMs, 283 drones; Qatar reported 65 BMs, 12 drones detected. Multi-layered defense systems have intercepted roughly half of all attacks per ACLED analysis."
};

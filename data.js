...
const MAP_META = {
    ...
    "lastUpdated": "2026-03-08T01:17:08.727Z",
    "casualties": {
        "killed": 26,
        "injured": 330
    },
    "conflict": "Iran strikes on Gulf states, Feb 28 – Mar 2, 2026",
    "summary": "War enters Day 9. Despite Iranian President Pezeshkian's March 7 apology and pledge to halt strikes on Gulf neighbors, IRGC launched drone swarm on Al Dhafra hours later. Parliament Speaker Ghalibaf contradicted Pezeshkian, stating Gulf states hosting US bases will continue to be targeted. Analysts say IRGC, not the president, controls military decisions. US Embassy Baghdad hit by rockets for first time in the conflict. UAE reports cumulative totals: 1,305 Iranian UAVs detected (1,229 intercepted, 76 impacted), 3 killed and 112 injured. CENTCOM says 3,000+ targets struck in Iran and 43 warships destroyed. Strait of Hormuz vessel traffic down to single digits per day.",
    "totalBarrage": "UAE alone: 1,305+ UAVs, 300+ ballistic missiles, 8 cruise missiles detected as of March 7. Kuwait: 97 ballistic missiles, 283 drones. Bahrain: 75+ missiles, 123+ drones. Qatar: 65+ ballistic missiles, 12+ drones. NDTV estimates Iran may have ~1,000 ballistic missiles remaining.",
    "intercepted": "UAE intercepted 1,229 of 1,305 UAVs and majority of ballistic missiles. Multi-layered defense systems across region intercepting approximately half of all attacks per ACLED analysis. Ballistic missile launches down ~90% from Day 1 per CENTCOM."
};

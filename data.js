...
const MAP_META = {
    ...
    "lastUpdated": "2026-03-11T10:32:44.622Z",
    "casualties": {
        "killed": 64,
        "injured": 783
    },
    "conflict": "Iran strikes on Gulf states, Feb 28 – Mar 2, 2026",
    "summary": "Day 12 (March 11): IRGC launched 37th wave of Operation True Promise IV using Khoramshahr heavy ballistic missiles, targeting 5th Fleet in Bahrain, Erbil in Iraq, and Israel. Iran's Khatam al-Anbiya joint military HQ declared banks and financial institutions across the Middle East are now targets — an escalatory threat particularly to Dubai (DIFC), Bahrain, and Saudi Arabia. UAE reports 1,475 total drones detected since Feb 28 (1,385 intercepted, 90 impacted on land). Bahrain evacuated Gulf Air aircraft from its airport. UN Security Council to vote on GCC resolution demanding Iran stop attacking Arab neighbors. Only 7 ships have transited the Strait of Hormuz since March 8 vs normal 100+/day.",
    "totalBarrage": "IRGC at 37th wave of Operation True Promise IV. Iran has fired 500+ ballistic/naval missiles and ~2,000 drones since Feb 28 (per Fars News Agency, March 5). UAE alone tracked 1,475 drones. Ballistic missile launch rate down 90% and drone rate down 83% from Day 1 per US CJCS.",

...
const MAP_META = {
    ...
    "lastUpdated": "2026-03-07T15:19:50.863Z",
    "casualties": {
        "killed": 21,
        "injured": 250
    },
    "conflict": "Iran strikes on Gulf states, Feb 28 – Mar 2, 2026",
    "summary": "Day 8 (March 7): Iran's President Pezeshkian announced forces ordered to halt Gulf attacks unless Iran is attacked from those territories, but IRGC 'mosaic defence' doctrine allows decentralized commanders to act independently. Despite the announcement, dozens of strikes continued across the Gulf on Saturday. UAE intercepted 15 of 16 ballistic missiles and 119 of 121 drones on Saturday alone. Qatar confirmed new missile attacks intercepted Saturday. Bahrain intercepted 6 more missiles and 4 more drones overnight. Saudi Arabia foiled 6 drones towards Shaybah, 2 BMs towards PSAB, and 1 drone near Riyadh. Three Erbil, Iraq locations added to map—repeated militia and Iranian drone attacks on airport, US base, and hotel since Feb 28 not previously tracked. Missile interception over Aqaba, Jordan also added.",
    "totalBarrage": "UAE cumulative since Feb 28: 221 BMs detected (205 destroyed, 14 into sea, 2 impacted territory), 1,305 drones (1,229 intercepted, 76 impacted), 8 cruise missiles (all destroyed). Bahrain: 84 missiles, 147 drones intercepted. Kuwait: 97+ BMs, 283+ drones. Qatar: 65+ BMs, 12+ drones intercepted. Jordan: 49+ UAVs/BMs intercepted, 73 debris incidents. Iran claims 500+ ballistic/naval missiles and ~2,000 drones launched total since Feb 28 (Fars News, March 5).",
    "intercepted": "Saturday March 7 alone — UAE: 15/16 BMs, 119/121 drones. Saudi: 2 BMs (PSAB), 6 drones (Shaybah), 1 drone (Riyadh). Qatar: missile attack intercepted. Bahrain: +6 missiles, +4 drones overnight. Overall interception rates remain high (>90% for BMs, >85% for drones) but sustained saturation attacks ensure some penetration."
};

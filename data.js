...
const MAP_META = {
    ...
    "lastUpdated": "2026-03-10T06:39:27.370Z",
    "casualties": {
        "killed": 51,
        "injured": 691
    },
    "conflict": "Iran strikes on Gulf states, Feb 28 – Mar 2, 2026",
    "summary": "Day 11 (March 10): IRGC Air Force commander announced Iran will deploy only warheads over 1 tonne with increased frequency and expanded range, rejecting US claims its missile programme is destroyed. Mojtaba Khamenei consolidates power as new supreme leader with pledges of allegiance from IRGC and top leaders. Trump threatens to hit Iran '20 times harder' if Strait of Hormuz oil traffic is blocked. Bapco (Bahrain) declares force majeure — first Gulf state energy company to do so. Oil prices remain above $100/barrel (Brent at ~$113). US ordered non-emergency staff departure from Saudi Arabia. 8th US soldier confirmed killed (Sgt. Pennington at Prince Sultan Air Base).",
    "totalBarrage": "Iran has fired over 500 ballistic/naval missiles and nearly 2,000 drones since Feb 28 (per Fars News Agency, March 5). IRGC now threatens heavier warheads and increased launch tempo.",
